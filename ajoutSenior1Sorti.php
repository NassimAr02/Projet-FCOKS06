...
$idLicence = "";
$equipements = [
    ['nom' => 'Parka', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Haut survetement', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Bas survetement', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Polo', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Short', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Basket', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Claquette', 'type' => 'Sorti/Senior1'],
    ['nom' => 'Sac', 'type' => 'Sorti/Senior1'],
];
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < $countEquipements; $i++) {
        ...
        $taillesUtilisees = ($nomEquipement == 'Basket' || $nomEquipement == 'Claquette') ? $tailles2 : (($nomEquipement == 'Sac') ? $tailles3 : $tailles);
        $tailleEquipement = isset($_POST['taille'][$i]) ? htmlspecialchars($_POST['taille'][$i]) : "";
        $distribue = isset($_POST['distribue_Sorti'][$i]) ? htmlspecialchars($_POST['distribue_Sorti'][$i]) : "";
        ...
        if ($nomEquipement == 'Basket' || $nomEquipement == 'Claquette') {
            if (!in_array($tailleEquipement, $tailles2)) {
                $allFieldsFilled = false;
                break;
            }
        } else if ($nomEquipement == 'Sac') {
            if (!in_array($tailleEquipement, $tailles3)) {
                $allFieldsFilled = false;
                break;
            }
        } else {
        ...
        try {
            ...
            $stmt->execute([$tailleEquipement, $dateDistribution, $nomEquipement, $distribue, $typeEquipement, $idLicence, $saisonSelectionnee] );
        ...
        header("Location: ajoutSenior1Entrainement.php?idLicence=" . urlencode($idLicence));
        exit();
    ...
    <div class="formulaire1">
        <form action="" method="POST">
            ...
            <div class="form">
                ...
                <input type="text" id="typeEquipement" name="typeEquipement" value="Sorti/Senior1" readonly>
            </div>
            <br>
            <div class="form">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="radio-container">
                                    <label><input type="checkbox" name="distribue_Sorti[<?php echo $index; ?>]" value="1"></label>
                                </div>
                            </td>
                            <td>
