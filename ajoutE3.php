...
$equipements = [
    ['nom' => 'Veste', 'type' => 'Educateur'],
    ['nom' => 'Pantalon', 'type' => 'Educateur'],
    ['nom' => 'Maillot', 'type' => 'Educateur']
...
<head>
    ...
    <title>Ajout d'équipement d'éducateur</title>
    ...
    <div class="formulaire1">
        <form action="" method="POST">
            ...
            <div class="form">
                ...
                <input type="text" id="typeEquipement" name="typeEquipement" value="Educateur" readonly>
            </div>
            <br>
            <div class="form">
